    	...
    	<td id="rig_top" >
            ...
            <table class="content" style="font-size:12px;">
                ...
                <tr>
                    ...
                    <td class="inp"><input type="text"  style="background:url(images/search.png) no-repeat 226px center #F6F9FD;" onclick="data()"/></td>
                    <td style="color:#00F">发票日期</td>
                    <td class="inp"><input type="text" value="1.00" style="text-align:right"/></td>
                    <td style="color:#00F">票到日期</td>
                    <td class="inp"><input type="text" value="1.00" style="text-align:right"/></td>
                </tr>
                <tr>
                    <td class="one" style="color:#00F">供应商</td>
                    <td class="inp"><input type="text"  style="background:url(images/search.png) no-repeat 226px center #F6F9FD;" onclick="data()"/></td>
                    <td class="one" style="color:#00F">采购部门</td>
                    <td class="inp"><input type="text"  style="background:url(images/search.png) no-repeat 226px center #F6F9FD;" onclick="data()"/></td>
                	<td class="one" style="color:#00F">发票类型</td>
                    <td class="inp"><input type="text"  style="background:url(images/search.png) no-repeat 226px center #F6F9FD;" onclick="data()"/></td>
                </tr>
                <tr>
    	...
    	<td id="rig_top" >
            ...
            <table cellspacing="0" cellpadding="0" id="maintain-top" align="center"  width="2000"  style="font-size:12px;">
                <tr class="one">
                    ...
                    <td width="90">发票号</td>
                    <td width="90">单据状态</td>
                    <td width="180">发票日期</td>
                    <td width="90">票到日期</td>
                    <td width="90">供应商</td>
                    <td width="90">采购部门</td>
                    <td style="color:#00F;" width="90">发票类型</td>
                    <td  width="90">业务员</td>
                    <td style="color:#00F;"  width="90">币种</td>
                    <td width="90">整单税率</td>
                    <td width="90">是否已传应付</td>
                </tr>
                <tr>
    	...
    	<td id="right_center" >
            ...
            <table cellspacing="0" cellpadding="0"  id="maintain-right"  style="font-size:12px;">
                <tr class="two" align="center">
					...
					<td width="100">批次</td>
					<td width="100">发票数量</td>
					<td width="100">金额</td>
					<td width="100">币种</td>
					<td width="200">含税单价</td>
					<td width="200">税率</td>
					<td width="200">税额</td>
					<td width="200">无税金额</td>
