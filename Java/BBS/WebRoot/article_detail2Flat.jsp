...
<%@ page import="java.sql.*,com.lk.bbs.*,java.util.*"%>
<%
	//如果没取得id的值或者获得空的字符串值,显示Error id.
...
<html>
<head>
<title>Java|Java世界_中文论坛|ChinaJavaWorld技术论坛 : <%=article.getTitle()%></title>
