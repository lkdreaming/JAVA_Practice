	...
	<tr>
    	<td id="rig_top" >
            ...
            <table class="content" style="font-size:12px;">
                ...
                <tr>
                    <td style="color:#00F">供应商</td>
                    <td class="inp"><input type="text"  style="background:url(images/search.png) no-repeat 226px center #F6F9FD;" onclick="data()"/></td>
                    <td style="color:#00F">采购部门</td>
                    <td class="inp"><input type="text" value="1.00" style="text-align:right"/></td>
                    <td style="color:#00F">采购人</td>
                    <td class="inp"><input type="text" value="1.00" style="text-align:right"/></td>
                </tr>
                <tr>
                    <td class="one" style="color:#00F">是否退货</td>
                    <td class="inp"><input type="text"  style="background:url(images/search.png) no-repeat 226px center #F6F9FD;" onclick="data()"/></td>
                    <td class="one" style="color:#00F">解冻人</td>
                    <td class="inp"><input type="text"  style="background:url(images/search.png) no-repeat 226px center #F6F9FD;" onclick="data()"/></td>
                	<td class="one" style="color:#00F">订单日期</td>
                    <td class="inp"><input type="text"  style="background:url(images/search.png) no-repeat 226px center #F6F9FD;" onclick="data()"/></td>
                </tr>
                <tr>
                    <td style="color:#00F">订单状态</td>
                    <td class="inp"><input type="text" value="1.00" style="text-align:right"/></td>
                    <td style="color:#00F">币种</td>
                    <td class="inp"><input type="text" value="1.00" style="text-align:right"/></td>
                    <td style="color:#00F">整单税率</td>
                    <td class="inp"><input type="text" value="1.00" style="text-align:right"/></td>
                </tr>
                <tr>
                    <td style="color:#00F">冻结状态</td>
                    <td class="inp"><input type="text" value="1.00" style="text-align:right"/></td>
                </tr>
				<tr>
                	<td colspan="5"></td>
    	...
    	<td id="rig_top" >
            ...
            <table cellspacing="0" cellpadding="0" id="maintain-top" align="center"  width="2000"  style="font-size:12px;">
                <tr class="one">
                    ...
                    <td width="90">单据号</td>
                    <td width="90">供应商</td>
                    <td width="180">采购部门</td>
                    <td width="90">采购人</td>
                    <td width="90">是否退货</td>
                    <td width="90">解冻人</td>
                    <td style="color:#00F;" width="90">订单日期</td>
                    <td  width="90">订单状态</td>
                    <td style="color:#00F;"  width="90">币种</td>
                    <td width="90">整单税率</td>
                    <td width="90">冻结状态</td>
                </tr>
                <tr>
    	...
    	<td id="right_center" >
            ...
            <table cellspacing="0" cellpadding="0"  id="maintain-right"  style="font-size:12px;">
                <tr class="two" align="center">
                    ...
                    <td width="200">是否行关闭</td>
                    <td width="200">关闭人</td>
                    <td width="200">关闭日期</td>
                    <td width="100">规格</td>
                    <td width="100">型号</td>
                    <td width="100">单位</td>
                    <td width="100">数量</td>
					...
					<td width="100">税额</td>
					<td width="200">赠品</td>
					<td width="200">来源单据</td>
					<td width="200">累计退货数量</td>
					<td width="200">行状态</td>
