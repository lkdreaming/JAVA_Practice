    	...
    	<td id="rig_top" >
            ...
            <table class="content" style="font-size:12px;">
                ...
                <tr>
                    ...
                    <td class="inp"><input type="text" value="1.00" style="text-align:right"/></td>
                    <td style="color:#00F">制单时间</td>
                    <td class="inp"><input type="text" value="1.00" style="text-align:right"/></td>
                    <td style="color:#00F">审批人</td>
                    <td class="inp"><input type="text" value="1.00" style="text-align:right"/></td>
                </tr>
                <tr>
                    <td style="color:#00F">审批时间</td>
                    <td class="inp"><input type="text" value="1.00" style="text-align:right"/></td>
    	...
    	<td id="right_center" >
            ...
            <table cellspacing="0" cellpadding="0"  id="maintain-right"  style="font-size:12px;">
                <tr class="two" align="center">
					...
					<td width="100">应收数量</td>
					<td width="100">实收数量</td>
					<td width="100">单价</td>
					<td width="100">金额</td>
					<td width="100">入库日期</td>
					<td width="100">赠品</td>
					<td width="100">源头单据号</td>
					<td width="100">源头行号</td>
					<td width="100">来源单据号</td>
					<td width="100">来源行号</td>
                ...
                <tr style="background:#ECF4FB; font-size:12px;"  height="30">
                <td colspan="20" style="border-right:0;border-top:1px solid #8FAFD7;">&nbsp;&nbsp;共有 120 条记录，当前第 1/10 页</td>
