...
<div id="Title_bar">
    <div id="Title_bar_Head"> 
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="images/title_arrow.gif"/> 用户管理
        </div>
...
<div id="MainArea">
    <table cellspacing="0" cellpadding="0" class="TableStyle">
        ...
        <tbody id="TableData" class="dataContainer" datakey="userList">
        	<s:iterator value="#users">
	            <tr class="TableDetail1 template">
	                ...
	                <td><s:property value="getDepartment().getDname()"/></td>
	                <td>
     ...
     <div id="TableTail">
        <div id="TableTail_inside">
            <a href="userAction_addUI.action"><img src="images/createNew.png" /></a>
        </div>
    </div>
    ...
    <div class="ItemBlock_Title1" id="privilegeTitle" style="display: none;"><div class="ItemBlock_Title1">
        	<img border="0" width="4" height="7" src="images/item_point.gif" />选择角色</div> 
        </div>
        ...
        <div id="InputDetailBar">
            <image id="savePrivilege" src="images/save.png"/>
        </div>
</div>
</body>
</html>