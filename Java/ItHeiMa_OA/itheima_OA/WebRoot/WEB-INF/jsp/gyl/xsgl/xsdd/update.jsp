...
<body>
<s:form action="xsddAction_updateUI_Info.action">
<table id="wrap">
	<td id="rig_top" >
	...
	<tr>
    	<td id="rig_top" >
            ...
            <table cellspacing="0" cellpadding="0" id="maintain-top" align="center"  width="2000"  style="font-size:12px;">
                ...
                <tr>
                    <td><s:property value="query_zhub.dhrq"/></td>
                    <td><s:property value="query_zhub.sxrq"/></td>
                    <td><s:property value="query_zhub.khmc"/></td>
                    <td><s:property value="query_zhub.zdkl"/></td>
                    <td><s:property value="query_zhub.sxbm"/></td>
                    <td><s:property value="query_zhub.yww"/></td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td><s:property value="query_zhub.zdjshj"/></td>
                    <td><s:property value="query_zhub.sxkje"/></td>
                </tr>
            </table>
           </div>
		</td>
                ...
                <s:if test="#pageResult_zhib!=null">
                	<s:iterator value="#pageResult_zhib.rows">
		                <tr align="center">
		                    ...
		                    <td style="border-collapse:collapse;  empty-cells:show;" item="chbm"><s:property value="chbm"/></td>
