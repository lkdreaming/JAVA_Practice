    	...
    	<td id="right_center" >
            ...
            <table cellspacing="0" cellpadding="0"  id="maintain-right"  style="font-size:12px;" width="5000">
                <tr class="two" align="center">
					...
					<td width="100" field="zdkl">整单扣率</td>
                ...
                <tr align="center">
                    <td style="width:30px; text-align:center; background:#E2E2E2;" item='hh'>1</td>
                    <td style="border-collapse:collapse;  empty-cells:show;"><input type="text" style="width:100%;" name="xsddzhibs[0].chbm"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;"><input type="text" style="width:100%;" name="xsddzhibs[0].chmc"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;"><input type="text" style="width:100%;" name="xsddzhibs[0].gg"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;"><input type="text" style="width:100%;" name="xsddzhibs[0].xh"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;"><input type="text" style="width:100%;" name="xsddzhibs[0].dw"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;"><input type="text" style="width:100%;" name="xsddzhibs[0].sl"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;"><input type="text" style="width:100%;" name="xsddzhibs[0].shulv"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;"><input type="text" style="width:100%;" name="xsddzhibs[0].dpkl"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;"><input type="text" style="width:100%;" name="xsddzhibs[0].zdkl"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;"><input type="text" style="width:100%;" name="xsddzhibs[0].wsdj"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;"><input type="text" style="width:100%;" name="xsddzhibs[0].hsdj"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;"><input type="text" style="width:100%;" name="xsddzhibs[0].wsje"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;"><input type="text" style="width:100%;" name="xsddzhibs[0].hsje"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;"><input type="text" style="width:100%;" name="xsddzhibs[0].se"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;"><input type="text" style="width:100%;" name="xsddzhibs[0].zke"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;"><input type="text" style="width:100%;" name="xsddzhibs[0].pc"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;"><input type="text" style="width:100%;" name="xsddzhibs[0].gs"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;"><input type="text" style="width:100%;" name="xsddzhibs[0].fhck"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;"><input type="text" style="width:100%;" name="xsddzhibs[0].shdw"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;"><input type="text" style="width:100%;" name="xsddzhibs[0].jhfhrq"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;"><input type="text" style="width:100%;" name="xsddzhibs[0].yqshrq"/></td>
                </tr>
            </table>
           </div>
    	</td>
