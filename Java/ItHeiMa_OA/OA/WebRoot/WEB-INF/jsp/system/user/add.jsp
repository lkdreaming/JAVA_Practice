            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td width="100">所属部门</td>
                        <td><select name="department.departmentId" class="SelectStyle">
                    ...
                    <tr><td>登录名</td>
                        <td><input type="text" name="user.loginName" class="InputStyle"/> *
							（登录名要唯一）
						</td>
                    </tr>
                    <tr><td>姓名</td>
                        <td><input type="text" name="user.userName" class="InputStyle"/> *
						</td>
                    </tr>
					<tr><td>性别</td>
                        <td><input type="RADIO" name="user.sex" value="男" id="male"/><label for="male">男</label>
							<input type="RADIO" name="user.sex" value="女" id="female"/><label for="female">女</label>
						</td>
                    </tr>
					<tr><td>联系电话</td>
                        <td><input type="text" name="user.phone" class="InputStyle"/></td>
                    </tr>
                    <tr><td>E-mail</td>
                        <td><input type="text" name="user.email" class="InputStyle"/></td>
                    </tr>
                </table>
            </div>
        </div>
