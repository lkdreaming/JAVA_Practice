        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td>部门名称</td>
                        <td><input type="text" name="name" class="InputStyle" value="<s:property value="department.departmentName"/>"/> *</td>
                    </tr>
                    <tr><td>职能说明</td>
                        <td><textarea name="description" class="TextareaStyle"><s:property value="department.description"/></textarea></td>
                    </tr>
                </table>
            </div>
        </div>
