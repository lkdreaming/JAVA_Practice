...
/*	private static SessionFactory sf;
	...
	public void testParentChildren() {
		...
		List<Orgnization> children = new ArrayList<Orgnization>();
	...
	public void testListChildren() {
		testSaveOrg();
		OrgDaoImpl odi = new OrgDaoImpl();
		List<Orgnization> children = odi.loadChildren(0);
		Iterator<Orgnization> it = children.iterator();
		it.next();
		while(it.hasNext()) {
	...
	public void a() {
		testSaveOrg();
		System.out.println(orgService.loadChildren(3).get(0).getName());
