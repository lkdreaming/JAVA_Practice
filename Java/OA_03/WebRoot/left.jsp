...
<body style="background:#fff3e1;">
    ...
    <span><img src="images/leftico01.png" /></span>管理信息
        ...
        <li>
            <div class="header">
            <cite></cite>
            <a href="right.html" target="rightFrame">通讯录</a>
            <i></i>
            </div>                
            <ul class="sub-menus">
            <li><a href="org!list.action" target="rightFrame">机构管理</a></li>
            <li><a href="org/add_input.jsp" target="rightFrame">人员管理</a></li>
            <li><a href="org" target="rightFrame">我的数据列表</a></li>
            <li><a href="javascript:;" target="rightFrame">自定义</a></li>
            </ul>
        </li>
